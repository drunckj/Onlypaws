...
export default function Dogs() {
    ...
    useEffect(() => {
        fetch("https://api.reddit.com/r/puppies.json?sort=new&limit=50")
            .then((response) => response.json())
            .then((json) => {
                setData((data) => data.concat(json.data.children));
            });
        fetch("https://api.reddit.com/r/Cutedogsreddit.json?sort=hot&limit=50")
            .then((response) => response.json())
            .then((json) => {
                setData((data) => data.concat(json.data.children));
            });

        fetch("https://api.reddit.com/r/IllegallySmolDogs.json?sort=hot&limit=20")
            .then((response) => response.json())
            .then((json) => {
                setData(data => data.concat(json.data.children))
